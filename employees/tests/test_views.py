...
class EmployeeViewSetTestCase(AuthenticatedTenantTestMixin, TenantTestCase):
    ...
    def test_list_without_authentication(self):
        ...
        response = self.client.get(self.list_url, HTTP_X_CLIENT=self.tenant_id)
    ...
    def test_retrieve_without_authentication(self):
        ...
        response = self.client.get(url, HTTP_X_CLIENT=self.tenant_id)
    ...
    def test_update_without_authentication(self):
        ...
        response = self.client.patch(
            url, data, content_type="application/json", HTTP_X_CLIENT=self.tenant_id
        )
    ...
    def test_delete_without_authentication(self):
        ...
        response = self.client.delete(url, HTTP_X_CLIENT=self.tenant_id)
